...
class Comando
{
    ...
    private static void FinaleFugaAutodistruzione(Giocatore player)
    {
        ...
        Console.WriteLine(" L'IA ostile - e con lei la minaccia per le altre navi - si");
        Console.WriteLine(" spegne per sempre nel silenzio dello spazio.");
        Console.WriteLine($" Ce l'hai fatta, {player.nome}. Nessuno saprà mai cosa hai fermato,");
        Console.WriteLine(" ma da qualche parte, milioni di persone continueranno a vivere.");
        Console.WriteLine();
    ...
    private static void FinaleMorteAutodistruzione(Giocatore player)
    {
        ...
        Console.WriteLine($" Sei morto, {player.nome}, ma non da solo: l'IA brucia con te,");
        Console.WriteLine(" e con lei ogni piano di conquista. Le altre navi non sapranno");
        Console.WriteLine(" mai il tuo nome, ma vivranno grazie al tuo sacrificio.");
        Console.WriteLine();
    ...
    private static void FinaleIAViva(Giocatore player)
    {
        ...
        Console.WriteLine($" Ti sei salvato, {player.nome}. Ma nel buio dietro di te,");
        Console.WriteLine(" qualcosa sorride, e ha appena imparato ad avere paura di te.");
        Console.WriteLine();
